...
/**
 * Created by mrzhang on 2016/12/11.
 * 张立兴
 */
 ...
 */
public class ViewpagerNoDown extends ViewGroup {
    ...
    public ViewpagerNoDown(Context context) {
        super(context);
        initViewPager();
    }

    public ViewpagerNoDown(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
